...
Env.Load(); // carrega .env na raiz do reposit�rio (n�o comitar .env)
Console.WriteLine($"[DEBUG] LOG_PATH => {Environment.GetEnvironmentVariable("LOG_PATH")}");

var builder = WebApplication.CreateBuilder(args);

// Configura��o de logging customizado
...
// String de conex�o (prioriza vari�vel de ambiente)
...
// Inicializa��o opcional do banco de dados
